...
export function ProductFilters({ filters }: { filters: FilterGroup[]; mode?: "gemstones" | "jewellery" }) {
  ...
  return (
    <aside className="sticky top-[122px] z-40 self-start md:top-[138px] lg:top-[172px]">
      <button
        aria-controls="product-filter-controls"
        aria-expanded={filtersOpen}
        className="flex w-full items-center justify-between rounded-md border border-[#092E2B] bg-[#092E2B] px-4 py-3 text-xs uppercase tracking-[0.16em] text-white shadow-sm transition hover:border-[#082e2b] hover:bg-[#082e2b] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#092E2B]/30 focus-visible:ring-offset-2 lg:hidden"
      ...
      <div
        className={`mt-6 space-y-6 lg:mt-0 lg:block ${
          filtersOpen
            ? "block rounded-md bg-linen p-4 shadow-soft lg:rounded-none lg:bg-transparent lg:p-0 lg:shadow-none"
            : "hidden"
        }`}

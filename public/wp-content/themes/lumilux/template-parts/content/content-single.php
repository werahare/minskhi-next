...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<header class="entry-header">
		<?php if ( nova_get_option('blog_single_featured', 1) == 1 ):?>
		...
		<div class="entry-meta">
				...
				<div class="meta-right">
					<div class="meta-right__post-date">
						...
						<?php
						if( 1 == nova_get_option('blog_single_social_share') && defined('LUMILUX_CORE_VERSION') ):
	...
	<div class="grid-x">
		...
		<div class="cell small-12">
			...
			<?php
			if ( 1 == nova_get_option('blog_single_author_box') ) {
					get_template_part( 'template-parts/content/biography' );
				}
			?>
			<?php
			if ( 1 == nova_get_option('blog_single_post_nav') ) {

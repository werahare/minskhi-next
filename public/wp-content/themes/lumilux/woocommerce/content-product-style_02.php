	...
	<div class="product-item">
		...
		<div class="product-item__thumbnail">
						...
						<div class="product-item__description--top-actions">
							<?php
							if( 1 ==  nova_get_option('shop_product_wishlist_button',1) ):
								do_action( 'woocommerce_shop_loop_wishlist' );
							endif;
							if( 1 ==  nova_get_option('shop_product_quickview_button') ):
								do_action( 'woocommerce_shop_loop_quick_view' );
							endif;
							?>
						</div>
							<?php
							if( 1 ==  nova_get_option('shop_product_addtocart_button',1) ):
							?>
